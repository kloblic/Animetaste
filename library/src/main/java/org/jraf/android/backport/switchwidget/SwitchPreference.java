...
public class SwitchPreference extends TwoStatePreference {
	...
	public SwitchPreference(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.SwitchPreference, R.attr.switchPreferenceStyler, 0);
	...
	public SwitchPreference(Context context, AttributeSet attrs) {
		this(context, attrs, R.attr.switchPreferenceStyler);
	}
	...
	protected void onBindView(View view) {
		...
		Switchs checkableView = (Switchs) view.findViewById(R.id.switchWidget);
		if (checkableView != null /* && checkableView instanceof Checkable */) {
			...
			// if (checkableView instanceof Switch) {
				final Switchs switchView =/* (Switch) */ checkableView;
