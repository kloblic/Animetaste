...
public class LoadActivity extends ActionBarActivity{
	...
	private Context mContext;
        ...
        public void handleMessage(Message msg) {
            ...
            Log.e(TAG, TAG + "  executeHandler  " +msg);
    ...
    private Handler errorHandler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            Log.e(TAG, TAG + "  errorHandler  "+msg);
    ...
    private class PrepareTask extends AsyncTask<Void,Void,Boolean>{
        ...
        public PrepareTask(JSONObject setupObject){
            ...
            Log.e(TAG, TAG + "  PrepareTask  ");
        }

        @Override
        protected Boolean doInBackground(Void... voids) {
            Log.e(TAG, TAG + "  doInBackground  ");
            try{
